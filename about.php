...
<section style="margin-top: 70px; color: black; padding: 30px; line-height:1.7; background-color:#fff; ">
    ...
    <h2 style="margin-top:30px; color:#222;">Vision & Mission</h2>
    <p>
    ...
    <h2 style="margin-top:30px; color:#222;">Academic Excellence</h2>
    <p>
    ...
    <h2 style="margin-top:30px; color:#222;">Our Commitment</h2>
    <p>

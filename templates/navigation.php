    ...
    <div style="position:relative;">
        ...
        <nav id="navLinks" style="display:none; position:absolute; top:100%; right:0; padding:10px; border:1px solid #ccc; background:white;">
            <ul style="list-style:none; padding:0; margin:0;">
                ...
                <li><a href="/contact/contact.php" style="text-decoration:none; color:black; display:block; padding:5px 10px;">Contact</a></li>
                ...
                <li><a href="/staff.php" style="text-decoration:none; color:black; display:block; padding:5px 10px;">Teachers</a></li>
                <li><a href="/submit-feedback.php" style="text-decoration:none; color:black; display:block; padding:5px 10px;">Feedbacks</a></li>
                <li><a href="/testimonials.php" style="text-decoration:none; color:black; display:block; padding:5px 10px;">Testimonials</a></li>
                <li><a href="/Payments/school-payment/index.php" style="text-decoration:none; color:black; display:block; padding:5px 10px;">Payments</a></li>
            </ul>
        </nav>
    </div>
</header>
